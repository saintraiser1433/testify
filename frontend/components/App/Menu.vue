...
<template>
  <aside :class="store.isOpen ? 'lg:w-60' : '-translate-x-full lg:w-20 lg:translate-x-0'"
    ...
    <div class="flex ml-2 items-center border-b border-slate-300 dark:border-colorBorder pb-2 text-center mb-2">
      <span class="sprite sprite-small-lg ml-2"></span>
      <span :class="store.isOpen ? 'lg:block' : 'lg:hidden'" class="font-titleFont font-bold text-lg ml-2">
        Testify</span>
    </div>
