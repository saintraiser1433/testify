  ...
  <div class="flex justify-center items-center min-h-screen">
    <UICard :has-header="false" :body="{ base: 'dark:bg-gray-800', padding: 'sm:px-0 sm:py-0 px-0 py-0 ' }" :defaults="{
      ...
      <div class="grid grid-cols-12">
        ...
        <div class="relative col-span-6 bg-gradient-to-r from-orange-50 to-blue-50 hidden lg:inline-block">
          <NuxtImg src="/bg-image/exam.png" fit="cover" height="420" class="mt-3 ml-12" alt="Hero Bg" loading="lazy">
          </NuxtImg>
        </div>
      </div>
    </UICard>
