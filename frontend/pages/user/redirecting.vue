...
<template>
    <div class="flex justify-center items-center min-h-screen">
        <UICard :has-header="false" :body="{base:'dark:bg-gray-800'}" :defaults="{ base: 'max-w-xl px-5 mb-10 lg:py-10 border-t-4 border-primary ' }" :background="{base:'dark:bg-gray-800'}">
